				...
				<div className='flex justify-between items-center mb-4'>
					...
					<div className='flex items-center space-x-3'>
						...
						<button
							...
							className='cursor-pointer inline-flex items-center space-x-2 px-4 py-2 border border-transparent rounded text-sm font-medium text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black'>
							<AddSVG />
							<span>{t('create')}</span>
						</button>
					</div>
