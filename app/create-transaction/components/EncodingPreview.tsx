...
const EncodingPreview: React.FC<EncodingPreviewProps> = ({ previewContent }) => {
	...
	return (
		...
		<div className='bg-white py-6 flex flex-col gap-8 w-[558px] break-words'>
			...
			<div className='bg-gray-100 border p-4 rounded border-gray-300 text-sm font-mono whitespace-pre-wrap overflow-auto min-h-[200px]'>{previewContent ?? t('preview.noData')}</div>
		</div>
	);
};
