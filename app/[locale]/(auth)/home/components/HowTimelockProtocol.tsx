...
const HowTimelockWorks: React.FC = () => {
  return (
    ...
    <div className="
      bg-#F5F5F5 p-8 rounded-lg shadow-md border border-gray-200
      group
      hover:bg-black hover:shadow-lg hover:border-black
    ...
    ">
      ...
      <a
        ...
        className="
          ...
          bg-white text-black py-2 px-4 rounded-md text-sm font-semibold
          border border-gray-300
          hover:shadow-md /* Add shadow on hover for the button itself */
